...
if (isset($_POST['salvar'])) {
    ...
    $sql = "update autor set status = '{$status}' where id = {$id} ";
...
<body>
    <div class="container">
        <form method="POST">
            ...
            <a href="listarAutores.php" class="btn btn-l mt-3" style="background-color:#9c93cf;"><i class="fa-solid fa-rotate-left"></i> Voltar</a>
        </form>
    </div>
</body>
</html>
