...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01/12/2023 às 16:38
...
(36, 3, 37, 4, ''),
(42, 2, 38, 1, 'vinicius@gmail.com'),
(43, 3, 37, 2, 'vinicius@gmail.com');
...
INSERT INTO `itensvenda` (`id`, `venda_id`, `livros_id`, `quantidade`, `valor_unitario`) VALUES
(1, 7, 2, 1, 38.00),
(2, 7, 3, 2, 37.00),
(3, 8, 3, 1, 37.00),
(4, 8, 4, 1, 33.00),
...
INSERT INTO `usuario` (`id`, `nome`, `email`, `senha`, `dataNascimento`, `cpf`, `cidade`, `UF`, `cep`, `endereco`, `status`) VALUES
(1, 'Gabrielle', 'gabrielle@gmail.com', '1234', '', '0', 'Umuarama', 'PR', '', '', 1),
(2, 'Gabrielle', 'gabrielle@gmail.com', '1234', '', '0', 'Umuarama', 'PR', '', '', 1),
(3, 'Gabrielle', 'gabrielle@gmail.com', '1234', '', '0', 'Umuarama', 'PR', '', '', 1),
(4, 'Ana Laura Dias de Cabral', 'Nalauraaa@gmail.com', '56789', '10/03/20', '153246', 'Cafezal', 'AL', '', '', 1),
(5, 'Ana Laura Dias de Cabral', 'Nalauraaa@gmail.com', '56789', '10/03/20', '153246', 'Cafezal', 'AL', '', '', 1),
(6, 'Batista', 'Batistaaa@gmail.com', '4134321', '30/08/20', '243517', 'Cruzeiro', 'MT', '', '', 1),
(7, 'Gustavo Antonio', 'guuuuA@gmail.com', '243534645', '21/12/20', '084.709.149', 'Icaraíma', 'PE', '', '', 1),
(8, 'Gustavo Antonio', 'guuuuA@gmail.com', '23214124', '21/02/23', '111.111.111', 'Umuarama', 'PI', '', '', 1),
(25, 'ebfrenfdrenfde', 'favgd@bfrbfrn', '33213123', '2001-03-', '08470914901', 'Abadia dos Dourados', 'MG', '', '', 1),
...
INSERT INTO `venda` (`id`, `usuario_id`, `status`, `formadepagamento`, `valortotal`, `datacadastro`) VALUES
(7, 34, 1, 4, 112.00, '2023-12-01 10:09:37'),
(8, 4, 1, 4, 287.00, '2023-12-01 10:15:28'),
(9, 4, 1, 2, 151.00, '2023-12-01 11:29:06'),
(10, 4, 1, 1, 107.00, '2023-12-01 11:29:57'),
(11, 4, 1, 4, 107.00, '2023-12-01 11:33:19'),
(12, 4, 0, 2, 32.00, '2023-12-01 11:51:59'),
(13, 4, 0, 2, 38.00, '2023-12-01 11:52:55'),
(14, 4, 0, 2, 32.00, '2023-12-01 11:54:15'),
(15, 4, 0, 3, 38.00, '2023-12-01 12:03:00');
...
ALTER TABLE `livros`
  ...
  ADD KEY `fk_genero_livros` (`genero_id`);
...
--
ALTER TABLE `livros`
  ADD CONSTRAINT `fk_genero_livros` FOREIGN KEY (`genero_id`) REFERENCES `genero` (`id`),
